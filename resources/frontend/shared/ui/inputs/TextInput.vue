...
const props = defineProps({
  ...
  inputType: {
    type: String,
    validator(value) {
      return value === 'textarea' || value === 'text'
    },
    default: "text",
  },
  modelValue: {
...
const inputElClass = computed(() => {
  return [
    "px-2 py-1 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full border",
    "dark:placeholder-gray-400 bg-white dark:bg-slate-800",
    props.inputType === "textarea" ? "h-24" : "h-9",
